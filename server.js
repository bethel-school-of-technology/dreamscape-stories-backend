...
//import the routers
var router = require('./myapp/Routes/router');
var authenticate = require('./myapp/Routes/authentication')(passport);
...
var initPassport = require('./myapp/Passport/passport-init');
